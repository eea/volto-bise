...
const messages = defineMessages({
  ...
  withBorder: {
    id: 'With border',
    defaultMessage: 'With border',
  },
  roundedBorder: {
    id: 'Rounded border',
    defaultMessage: 'Rounded border',
  },
  openLinkInNewTab: {
        ...
        <>
          ...
          <Segment className="form sidebar-image-data">
            ...
            <TextWidget
              ...
              icon={data.titleColor ? clearSVG : null}
              iconAction={() =>
                onChangeBlock(block, {
                  ...data,
                  titleColor: '',
            ...
            <CheckboxWidget
              id="withBorder"
              title={intl.formatMessage(messages.withBorder)}
              value={data.withBorder ? data.withBorder : false}
              onChange={(name, value) => {
                onChangeBlock(block, {
                  ...data,
                  withBorder: value,
            ...
            {data.withBorder ? (
              <CheckboxWidget
                id="roundedBorder"
                title={intl.formatMessage(messages.roundedBorder)}
                value={data.roundedBorder ? data.roundedBorder : false}
                onChange={(name, value) => {
                  onChangeBlock(block, {
                    ...data,
                    roundedBorder: value,
