/**
 * FlexibleSelectWidget component (mostly copied from SelectWidget on 9th September of 2020).
 * @module components/theme/datablocks/ConnectedChart/FlexibleSelectWidget
 */
...
/**
 * FlexibleSelectWidget component class.
 *
 * The new prop is `hasNoValueItem`, by default `true`.
 *
 * @function FlexibleSelectWidget
 * @returns {string} Markup of the component.
 */
export class FlexibleSelectWidget extends Component {
  /**
   * Property types.
